...
// Transcoder is a Tencent Cloud CI transcoder.
...
func New(cfg Config) (*Transcoder, error) {
    ...
    return &Transcoder{client: client, bucketURL: cfg.BucketURL}, nil
}

// Name returns tencent.
func (t *Transcoder) Name() string { return "tencent" }

// CreatePreset is a no-op because CI receives the profile with each job.
func (t *Transcoder) CreatePreset(_ context.Context, _ transcoder.TranscodeTemplate) error {
    return nil
}
