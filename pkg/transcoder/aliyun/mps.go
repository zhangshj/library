...
// Translator is the Alibaba Cloud MTS transcoder.
...
func New(cfg Config) (*Translator, error) {
	...
	return &Translator{client: client, region: cfg.Region, roleARN: cfg.RoleARN, templates: make(map[string]string)}, nil
}

// Name returns aliyun.
func (t *Translator) Name() string { return "aliyun" }

// CreatePreset creates an MTS template and remembers its provider template ID.
func (t *Translator) CreatePreset(ctx context.Context, tmpl transcoder.TranscodeTemplate) error {
